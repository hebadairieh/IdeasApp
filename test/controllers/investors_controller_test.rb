...
class InvestorsControllerTest < ActionController::TestCase
  ...
  test "should create investor" do
    assert_difference('Investor.count') do
      post :create, investor: { idea_id: @investor.idea_id, info: @investor.info, user_name: @investor.user_name }
    end
  ...
  test "should update investor" do
    patch :update, id: @investor, investor: { idea_id: @investor.idea_id, info: @investor.info, user_name: @investor.user_name }
    assert_redirected_to investor_path(assigns(:investor))
  end
